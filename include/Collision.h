...
public:
    ...
    static void Collision_action(TransformComponent &player, KeyboardComponent &keyboard, const Vector2D old_player_position, ColliderComponent &collider_object);
};
